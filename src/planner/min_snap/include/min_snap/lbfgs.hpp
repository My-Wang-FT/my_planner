...
namespace lbfgs
{
    ...
    enum
    {
        ...
        /** id = -1024   Unknown error. */
        LBFGSERR_UNKNOWNERROR = -1024,
        /** id = -1023   Logic error. */
        LBFGSERR_LOGICERROR,
        /** id = -1022   The minimization process has been canceled. */
        LBFGSERR_CANCELED,
        /** id = -1021   Invalid number of variables specified. */
        LBFGSERR_INVALID_N,
        /** id = -1020   Invalid parameter lbfgs_parameter_t::mem_size specified. */
        LBFGSERR_INVALID_MEMSIZE,
        /** id = -1019   Invalid parameter lbfgs_parameter_t::g_epsilon specified. */
        LBFGSERR_INVALID_GEPSILON,
        /** id = -1018   Invalid parameter lbfgs_parameter_t::past specified. */
        LBFGSERR_INVALID_TESTPERIOD,
        /** id = -1017   Invalid parameter lbfgs_parameter_t::delta specified. */
        LBFGSERR_INVALID_DELTA,
        /** id = -1016   Invalid parameter lbfgs_parameter_t::min_step specified. */
        LBFGSERR_INVALID_MINSTEP,
        /** id = -1015   Invalid parameter lbfgs_parameter_t::max_step specified. */
        LBFGSERR_INVALID_MAXSTEP,
        /** id = -1014   Invalid parameter lbfgs_parameter_t::f_dec_coeff specified. */
        LBFGSERR_INVALID_FDECCOEFF,
        /** id = -1013   Invalid parameter lbfgs_parameter_t::s_curv_coeff specified. */
        LBFGSERR_INVALID_SCURVCOEFF,
        /** id = -1012   Invalid parameter lbfgs_parameter_t::xtol specified. */
        LBFGSERR_INVALID_XTOL,
        /** id = -1011   Invalid parameter lbfgs_parameter_t::max_linesearch specified. */
        LBFGSERR_INVALID_MAXLINESEARCH,
        /** id = -1010   The line-search step went out of the interval of uncertainty. */
        LBFGSERR_OUTOFINTERVAL,
        /** id = -1009   A logic error occurred; alternatively, the interval of uncertainty became too small. */
        LBFGSERR_INCORRECT_TMINMAX,
        /** id = -1008   A rounding error occurred; alternatively, no line-search step satisfies the sufficient decrease and curvature conditions. */
        LBFGSERR_ROUNDING_ERROR,
        /** id = -1007   The line-search step became smaller than lbfgs_parameter_t::min_step. */
        LBFGSERR_MINIMUMSTEP,
        /** id = -1006   The line-search step became larger than lbfgs_parameter_t::max_step. */
        LBFGSERR_MAXIMUMSTEP,
        /** id = -1005   The line-search routine reaches the maximum number of evaluations. */
        LBFGSERR_MAXIMUMLINESEARCH,
        /** id = -1004   The algorithm routine reaches the maximum number of iterations. */
        LBFGSERR_MAXIMUMITERATION,
        /** id = -1003   Relative width of the interval of uncertainty is at most lbfgs_parameter_t::xtol. */
        LBFGSERR_WIDTHTOOSMALL,
        /** id = -1002   A logic error (negative line-search step) occurred. */
        LBFGSERR_INVALIDPARAMETERS,
        /** id = -1001   The current search direction increases the objective function value. */
